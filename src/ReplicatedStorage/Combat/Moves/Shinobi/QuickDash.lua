...
function QuickDash:Activate(player, character, rootPart, placementCFrame, class, classData, moveType, currentMove)
    ...
    local VFX_ID = "QuickDash"..HttpService:GenerateGUID(false)
